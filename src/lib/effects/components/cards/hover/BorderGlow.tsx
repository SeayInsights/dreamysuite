...
.border-glow-card:not(:hover):not(.sweep-active) > .edge-light {
  opacity:0; transition:opacity 0.75s ease-in-out;
}
...
const BorderGlow = ({
  ...
  useEffect(() => {
    ...
    animateValue({ ease: easeInCubic, delay: 2500, duration: 1500, start: 100, end: 0, onUpdate: v => card.style.setProperty('--edge-proximity', v as unknown as string), onEnd: () => card.classList.remove('sweep-active') });
  }, [animated]);
