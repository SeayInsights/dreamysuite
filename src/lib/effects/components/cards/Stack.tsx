...
.stack-card { border-radius:1rem; overflow:hidden; width:100%; height:100%; display:flex; align-items:center; justify-content:center; }
.stack-card img { pointer-events:none; user-select:none; -webkit-user-drag:none; }
