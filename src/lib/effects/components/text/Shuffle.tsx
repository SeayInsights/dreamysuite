...
const __shuffleStyleId = 'rb-shuffle-styles';
if (typeof document !== 'undefined' && !document.getElementById(__shuffleStyleId)) {
  const __s = document.createElement('style');
  __s.id = __shuffleStyleId;
  __s.textContent = `.shuffle-parent {
