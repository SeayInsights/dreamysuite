...
export default function LineWaves({
  speed = 0.3, innerLineCount = 32.0, outerLineCount = 36.0, warpIntensity = 1.0,
  rotation = -45, edgeFadeWidth = 0.0, colorCycleSpeed = 1.0, brightness = 0.2,
  color1 = "#ffffff", color2 = "#ffffff", color3 = "#ffffff",
  enableMouseInteraction = true, mouseInfluence = 2.0,
}: any) {
  ...
  useEffect(() => {
    ...
    program = new Program(gl, {
      ...
      uniforms: {
        ...
        uWarpIntensity: { value: warpIntensity }, uRotation: { value: rotationRad },
