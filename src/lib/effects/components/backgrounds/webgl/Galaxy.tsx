...
void main() {
  ...
  if (uAutoCenterRepulsion > 0.0) {
    vec2 centerUV = vec2(0.0); float centerDist = length(uv - centerUV);
...
export default function Galaxy({
  ...
  useEffect(() => {
    ...
    program = new Program(gl, {
      ...
      uniforms: {
        uTime: { value: 0 }, uResolution: { value: new Color(gl.canvas.width, gl.canvas.height, gl.canvas.width / gl.canvas.height) },
