...
export const SettingsSchema = z.object({
  ...
  bgImageZoom: z.number().default(100),
  bgImagePositionX: z.number().default(50),
  bgImagePositionY: z.number().default(50),
  ...
  defaultAnimTrigger: z.string().nullable().default(null),
