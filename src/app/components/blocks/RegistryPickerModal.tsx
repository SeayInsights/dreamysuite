...
import { PRESET_STORES, STORE_LOGOS, PLATFORM_LABELS, PLATFORM_ICONS } from "./RegistryBlockTypes";
...
export function PickerModal({ onAddStore, onAddCustomStore, onAddFund, onClose }: PickerModalProps) {
