...
import { HistoryPanel } from "./SettingsHistory";

type PanelId = "domain" | "collaborators" | "privacy" | "guests" | "history";
...
const SETTINGS: {
  ...
  },
  {
    id: "privacy",
    label: "Privacy",
    hint: "Visibility + password",
    Icon: Shield,
  },
  {
    id: "guests",
    label: "Guests",
    hint: "RSVP & guest list",
    Icon: UsersRound,
  },
  {
    id: "history",
    label: "Version history",
    hint: "Save & restore snapshots",
    Icon: History,
  },
];
...
export function SettingsTray() {
  ...
  if (panel === "collaborators")
    return <CollaboratorsPanel onBack={() => setPanel(null)} />;
  if (panel === "privacy")
    return <PrivacyPanel onBack={() => setPanel(null)} />;
  if (panel === "guests") return <GuestsPanel onBack={() => setPanel(null)} />;
  if (panel === "history")
    return <HistoryPanel onBack={() => setPanel(null)} />;
